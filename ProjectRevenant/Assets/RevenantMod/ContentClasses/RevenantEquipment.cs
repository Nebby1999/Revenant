...
namespace RevenantMod
{
    ...
    /// </summary>
    public abstract class RevenantEquipment : IEquipmentContentPiece, IContentPackModifier
    {
        /// <summary>
        ...
        public abstract RevenantAssetRequest LoadAssetRequest();
        public abstract void Initialize();
        public abstract bool IsAvailable(ContentPack contentPack);
        public virtual IEnumerator LoadContentAsync()
        {
            RevenantAssetRequest request = LoadAssetRequest();
            ...
            {
                RevLog.Error("Invalid AssetRequest " + request.assetName + " of type " + request.boxedAsset.GetType());
            }
        }
