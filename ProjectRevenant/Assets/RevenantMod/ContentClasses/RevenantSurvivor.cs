...
namespace RevenantMod
{
    ...
    /// </summary>
    public abstract class RevenantSurvivor : ISurvivorContentPiece, IContentPackModifier
    {
        ...
        public abstract RevenantAssetRequest<SurvivorAssetCollection> LoadAssetRequest();
        public abstract void Initialize();
        public abstract bool IsAvailable(ContentPack contentPack);

        public virtual IEnumerator LoadContentAsync()
        {
            RevenantAssetRequest<SurvivorAssetCollection> request = LoadAssetRequest();
